...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(e,t,n){let r=new Float32Array(Po),i=new W(0,1,0);return new ya({name:`SphericalGaussianBlur`,defines:{n:Po,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Yo(){return new ya({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xo(){return new ya({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Zo(),fragmentShader:`
...
You can also download her resume or send a message via the form at the bottom of the page!`:t.includes(`hi`)||t.includes(`hello`)||t.includes(`hey`)||t.includes(`hola`)||t.includes(`help`)?`Hello! I am ready to answer your questions. Feel free to ask about her projects, education, technical skills, or internships!`:`I'm not sure I understand that question. However, you can read more details in the respective sections of this site or download her resume directly. You can also send her a direct message using the form below!`};return(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(`button`,{onClick:()=>t(!e),"aria-label":`Ask Kavita's Robot Assistant`,style:{position:`fixed`,bottom:`24px`,right:`24px`,zIndex:999,width:`74px`,height:`74px`,borderRadius:`50%`,backgroundColor:`transparent`,border:`none`,cursor:`pointer`,display:`flex`,alignItems:`center`,justifyContent:`center`,transition:`var(--transition-smooth)`,padding:0},children:(0,F.jsx)(Jl,{size:74,playing:!e})}),(0,F.jsxs)(`div`,{style:{position:`fixed`,bottom:`110px`,right:`24px`,zIndex:999,width:`360px`,maxWidth:`calc(100vw - 48px)`,height:`480px`,display:e?`block`:`none`,overflow:`visible`,transition:`var(--transition-smooth)`},children:[(0,F.jsx)(Ql,{isTyping:n}),(0,F.jsx)(Yl,{isTyping:n}),(0,F.jsx)(Xl,{isTyping:n}),(0,F.jsx)(Zl,{}),(0,F.jsxs)(`div`,{className:`chat-window-screen`,style:{width:`100%`,height:`100%`,backgroundColor:`var(--chat-bg)`,border:`2.5px solid var(--chat-border)`,borderRadius:`20px`,boxShadow:`var(--shadow-neon), 0 12px 40px rgba(0, 0, 0, 0.2)`,backdropFilter:`blur(20px)`,WebkitBackdropFilter:`blur(20px)`,display:`flex`,flexDirection:`column`,overflow:`hidden`,position:`relative`,zIndex:5},children:[(0,F.jsxs)(`div`,{style:{padding:`12px 20px`,backgroundColor:`rgba(16, 185, 129, 0.08)`,borderBottom:`1.5px solid var(--chat-border)`,display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`h4`,{style:{fontSize:`0.9rem`,fontWeight:700,color:`var(--text-primary)`,margin:0},children:`KY-Bot Torso-Screen`}),(0,F.jsxs)(`span`,{style:{fontSize:`0.7rem`,color:`var(--accent-cyan)`,display:`flex`,alignItems:`center`,gap:`3px`},children:[(0,F.jsx)(`span`,{style:{width:`6px`,height:`6px`,borderRadius:`50%`,backgroundColor:`var(--accent-cyan)`,display:`inline-block`}}),`Online & Playing`]})]}),(0,F.jsx)(`button`,{onClick:()=>t(!1),"aria-label":`Close Chatbot`,style:{background:`none`,border:`none`,color:`var(--text-secondary)`,cursor:`pointer`,padding:`4px`},children:(0,F.jsx)(de,{size:18})})]}),(0,F.jsxs)(`div`,{style:{flex:1,padding:`20px`,overflowY:`auto`,display:`flex`,flexDirection:`column`,gap:`12px`},className:`chat-feed`,children:[i.map((e,t)=>(0,F.jsx)(`div`,{style:{alignSelf:e.sender===`user`?`flex-end`:`flex-start`,backgroundColor:e.sender===`user`?`var(--chat-bubble-user)`:`var(--chat-bubble-bot)`,color:e.sender===`user`?`var(--chat-text-user)`:`var(--chat-text-bot)`,padding:`10px 14px`,borderRadius:e.sender===`user`?`14px 14px 2px 14px`:`14px 14px 14px 2px`,maxWidth:`85%`,fontSize:`0.88rem`,lineHeight:`1.45`,whiteSpace:`pre-line`,border:e.sender===`user`?`none`:`1px solid var(--chat-border)`},children:e.text},t)),n&&(0,F.jsxs)(`div`,{style:{alignSelf:`flex-start`,backgroundColor:`var(--chat-bubble-bot)`,color:`var(--chat-text-bot)`,padding:`10px 14px`,borderRadius:`14px 14px 14px 2px`,fontSize:`0.88rem`,border:`1px solid var(--chat-border)`,display:`inline-flex`,alignItems:`center`,gap:`4px`},children:[(0,F.jsx)(`span`,{className:`dot-typing`,style:{animationDelay:`0s`},children:`.`}),(0,F.jsx)(`span`,{className:`dot-typing`,style:{animationDelay:`0.2s`},children:`.`}),(0,F.jsx)(`span`,{className:`dot-typing`,style:{animationDelay:`0.4s`},children:`.`})]}),(0,F.jsx)(`div`,{ref:c})]}),(0,F.jsx)(`div`,{style:{padding:`0 20px 10px 20px`,display:`flex`,gap:`6px`,overflowX:`auto`,whiteSpace:`nowrap`,scrollbarWidth:`none`},className:`quick-chips`,children:l.map((e,t)=>(0,F.jsx)(`button`,{onClick:()=>u(e),style:{fontSize:`0.75rem`,padding:`6px 12px`,borderRadius:`20px`,backgroundColor:`var(--input-bg)`,border:`1px solid var(--input-border)`,color:`var(--text-secondary)`,cursor:`pointer`,transition:`var(--transition-fast)`},onMouseEnter:e=>{e.currentTarget.style.borderColor=`var(--accent-cyan)`,e.currentTarget.style.color=`var(--text-primary)`,e.currentTarget.style.backgroundColor=`rgba(16, 185, 129, 0.05)`},onMouseLeave:e=>{e.currentTarget.style.borderColor=`var(--input-border)`,e.currentTarget.style.color=`var(--text-secondary)`,e.currentTarget.style.backgroundColor=`var(--input-bg)`},children:e},t))}),(0,F.jsxs)(`form`,{onSubmit:e=>{e.preventDefault(),u(o)},style:{padding:`12px 20px`,borderTop:`1px solid var(--chat-border)`,display:`flex`,gap:`10px`,alignItems:`center`,backgroundColor:`rgba(255, 255, 255, 0.005)`},children:[(0,F.jsx)(`input`,{type:`text`,value:o,onChange:e=>s(e.target.value),placeholder:`Ask a question...`,style:{flex:1,backgroundColor:`var(--input-bg)`,border:`1px solid var(--input-border)`,borderRadius:`8px`,padding:`10px 14px`,color:`var(--text-primary)`,fontSize:`0.85rem`,outline:`none`,transition:`var(--transition-fast)`},onFocus:e=>e.target.style.borderColor=`var(--accent-cyan)`,onBlur:e=>e.target.style.borderColor=`var(--input-border)`}),(0,F.jsx)(`button`,{type:`submit`,"aria-label":`Send message`,style:{backgroundColor:`var(--input-bg)`,border:`1px solid var(--input-border)`,color:`var(--accent-cyan)`,padding:`10px`,borderRadius:`8px`,cursor:`pointer`,display:`flex`,alignItems:`center`,justifyContent:`center`,transition:`var(--transition-fast)`},onMouseEnter:e=>{e.currentTarget.style.backgroundColor=`var(--accent-cyan)`,e.currentTarget.style.color=`#fff`},onMouseLeave:e=>{e.currentTarget.style.backgroundColor=`var(--input-bg)`,e.currentTarget.style.color=`var(--accent-cyan)`},children:(0,F.jsx)(le,{size:16})})]})]})]}),(0,F.jsx)(`style`,{children:`
      ...
      `})]})}function eu(){let[e,t]=(0,_.useState)(()=>{let e=localStorage.getItem(`theme`);return e===`dark`||e===`light`?e:`dark`});return(0,_.useEffect)(()=>{document.documentElement.setAttribute(`data-theme`,e),localStorage.setItem(`theme`,e)},[e]),(0,F.jsxs)(`div`,{style:{minHeight:`100vh`,display:`flex`,flexDirection:`column`},children:[(0,F.jsx)(me,{theme:e,toggleTheme:()=>{t(e=>e===`dark`?`light`:`dark`)}}),(0,F.jsxs)(`main`,{style:{flex:1},children:[(0,F.jsx)(zl,{theme:e}),(0,F.jsx)(Bl,{}),(0,F.jsx)(ql,{}),(0,F.jsx)(Wl,{})]}),(0,F.jsx)($l,{}),(0,F.jsx)(Kl,{theme:e})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,F.jsx)(_.StrictMode,{children:(0,F.jsx)(eu,{})}));